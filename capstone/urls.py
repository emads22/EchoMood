...
urlpatterns = [
    ...
    path("mood/playlist", views.this_mood_playlist, name="this_mood_playlist"),
    path("mood/playlist/generate/<str:mood>", views.generate_playlist, name="generate_playlist"),
